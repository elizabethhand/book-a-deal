        ...
        <main className='main-div'>
            <form className="register-form" style={{ width: 450 }}>
                ...
                <div className="details-div">
                    <TextField {...register("firstName")} variant="outlined" type="text" placeholder="First Name"></TextField>
                    <TextField {...register("lastName")} variant="outlined" type="text" placeholder="Last Name"></TextField>
                </div>
                ...
                <Link to="/home" style={{ textDecoration: 'none' }}>
                    <Button color="secondary" variant="contained" onClick={registerUser}> Register</Button>
                </Link>
